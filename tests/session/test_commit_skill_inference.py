    ...
    return ResolvedOperations(
        upsert_operations=[
            ResolvedOperation(
                ...
                uris=["wfs://agent/default/skills/general-knowledge-flow/SKILL.md"],
            ),
            ResolvedOperation(
                old_memory_file_content=None,
                memory_fields={
                ...
                memory_type="session_skills",
                uris=["wfs://agent/default/skills/general-knowledge-steps/SKILL.md"],
            ),
        ],
...
async def test_session_compressor_v2_extract_agent_memories_returns_session_skills(monkeypatch):
            ...
            [
                {
                    "status": "success",
                    "action": "create",
                    "uri": "wfs://agent/default/skills/code-review",
                    "root_uri": "wfs://agent/default/skills/code-review",
                    "skill_md_uri": "wfs://agent/default/skills/code-review/SKILL.md",
                }
            ],
        )
    ...
    result = await compressor.extract_agent_memories(
        ...
        archive_uri="wfs://sessions/s1/history/archive_001",
    )
...
async def test_session_compressor_v2_run_extract_phase_dedups_duplicate_session_skill_creates(
    ...
    assert result[4][0]["uri"] == "wfs://agent/default/skills/general-knowledge-flow"
...
"""
    ...
    read_result = await provider.execute_tool(
        SimpleNamespace(
            name="read",
            arguments={"uri": "wfs://agent/default/skills/code-review/SKILL.md"},
        )
    )
    ...
    assert "wfs://agent/default/skills/code-review/SKILL.md" in provider.read_file_contents
...
async def test_skill_operation_updater_creates_skill_with_session_defaults():
    ...
    uri = "wfs://agent/default/skills/code-review/SKILL.md"
