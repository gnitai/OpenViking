...
class TestPageIdMap:
    def test_get_page_id_assigns_incremental_ids_for_existing_pages(self):
        ...
        id1 = pim.get_page_id("wfs://user/a/memories/profile.md")
        id2 = pim.get_page_id("wfs://user/a/memories/preferences/topic.md")
    ...
    def test_get_page_id_returns_same_id_for_duplicate_uri(self):
        ...
        id1 = pim.get_page_id("wfs://user/a/memories/profile.md")
        id2 = pim.get_page_id("wfs://user/a/memories/profile.md")
    ...
    def test_resolve_returns_uri_for_registered_existing_page(self):
        ...
        page_id = pim.get_page_id("wfs://user/a/memories/profile.md")

        assert pim.resolve(page_id) == "wfs://user/a/memories/profile.md"
    ...
    def test_register_new_page_id_resolves_uri_for_unseen_uri(self):
        ...
        pim.register_new_page_id("wfs://new-item", 105)

        assert pim.resolve(105) == "wfs://new-item"
    ...
    def test_get_page_id_returns_declared_page_id_for_unseen_registered_uri(self):
        ...
        assert pim.get_page_id("wfs://new-item") == 105

    def test_register_new_page_id_preserves_existing_primary_id_for_seen_uri(self):
        pim = PageIdMap()

        existing_id = pim.get_page_id("wfs://profile.md")
        pim.register_new_page_id("wfs://profile.md", 100)

        assert pim.get_page_id("wfs://profile.md") == existing_id
        assert pim.resolve(existing_id) == "wfs://profile.md"
        assert pim.resolve(100) == "wfs://profile.md"
    ...
    def test_has_links_enabled_after_new_page_id_registration(self):
        ...
        pim.register_new_page_id("wfs://new-item", 100)
